...
public: 	
	...
	*/
    ...
    void invertir() {
		Nodo *contFinal = _ult;
		Nodo *contInicio = NULL;
		
		while (contFinal != NULL)
		{
			//std::cout << "mi actual contFinal =>" << contFinal->_elem << "\n";
			// intercambio
			contInicio = contFinal->_sig;
			contFinal->_sig = contFinal->_ant;
			contFinal->_ant = contInicio;
			// avanzo <--
			contFinal = contFinal->_sig;			
		}
		// coloco el prim
		// coloco el ult
		contInicio = _ult;
